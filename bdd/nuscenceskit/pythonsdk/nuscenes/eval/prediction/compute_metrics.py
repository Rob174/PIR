...
""" Script for computing metrics for a submission to the nuscenceskit prediction challenge. """
import argparse
import json
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', help='Directory storing NuScenes data.', default='/data/sets/nuscenceskit')
